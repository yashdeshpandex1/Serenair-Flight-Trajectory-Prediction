...
def save_sequences(train_df, test_df, features, target, window_size=10,
    ...
    if task == 'next_instance':
        ...
        data_dir = Path('../data/rnn_data_next_instance/')
        data_dir.mkdir(parents=True, exist_ok=True)
        save_path = data_dir / 'flight_data_for_rnn_next_instance.npz'
        ...
        print('Data saved successfully (next instance)..')
    elif task == 'next_ten_mins':
        X_train_seq, y_train_seq, anchor_train_seq = prepare_rnn_data(
            df=train_df,
            features=features,
        ...
        data_dir = Path('../data/rnn_data_next_ten_mins/')
        data_dir.mkdir(parents=True, exist_ok=True)
        save_path = data_dir / 'flight_data_for_rnn_next_ten_mins.npz'
        ...
        np.savez_compressed(save_path,
                            ...
                            y_test = y_test_seq,
                            anchor_test = anchor_test_seq)
        print('Data saved successfully (next ten minutes)..')
